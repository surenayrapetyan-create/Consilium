...
- НЕ выбирай «победителя» и НЕ голосуй большинством автоматически. Одиночное мнение может быть самым правильным — выделяй такие случаи явно.
  ...
  try {
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 6000,
        // temperature убрали — он deprecated для Opus 4.7
